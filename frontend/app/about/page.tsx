        ...
        <div className="relative z-10 h-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 flex items-center">
          <div className="max-w-[520px] pt-24 lg:pt-0">
            ...
            <p className="mt-6 text-gray-600 text-sm md:text-base leading-7 max-w-[500px]">
              For over 50 years, HPMC has been at the forefront of extrusion
              technology, delivering innovative, reliable, and high-performance
          ...
          <div className="grid lg:grid-cols-12 gap-6 items-stretch">
            ...
            <div className="lg:col-span-4 flex flex-col justify-center">
              ...
              <p className="text-[var(--text-secondary)] leading-8 mb-6">
                ...
                Reprehenderit voluptas cumque laboriosam, dignissimos
                consequatur facere asperiores.
              </p>

              <p className="text-[var(--text-secondary)] leading-8 mb-10">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore
                rerum nostrum nemo, debitis ipsum adipisci voluptatem deserunt.
              </p>
            </div>
              ...
              <div className="max-w-xl">
                ...
                <ul className="mt-6 space-y-4">
                  {[
                    ...
                    "lorem ipsum  Dolore rerum nostrum nemo, debitis. ",
                    "ipsum adipisci voluptatem deserunt.",
                    "lorem ipsum consectetur nostrum nemo, debitis.",
                  ].map((item, i) => (
              ...
              <div className="relative bg-[var(--card)]">
                ...
                <div className="h-full flex flex-col justify-center px-8 lg:px-12 py-5">
                  ...
                  <p className="mt-4 text-[var(--text-secondary)] leading-8">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Molestiae, architecto. Officiis asperiores.
                  </p>
