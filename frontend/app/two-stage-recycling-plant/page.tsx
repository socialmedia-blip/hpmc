...
const faqData = [
  {
    ...
    answer:
      "A Two Stage Recycling Plant is an advanced plastic recycling system designed to reprocess waste and reclaimed plastic materials into high-quality reusable plastic granules or pellets for further manufacturing applications.",
  },
  {
    question: "What materials can be processed in the recycling plant?",
    answer:
      "The plant can process HIPS, Crystal, PP, LDPE, HDPE, ABS, and various engineering plastics, making it suitable for a wide range of recycling applications.",
  },
  {
    question: "What is the purpose of a Two Stage Recycling Extruder?",
    answer:
      "The two-stage design improves melt filtration, degassing, plasticization, and material homogenization, resulting in superior pellet quality and stable recycling performance.",
  },
  {
    question: "What is the production capacity of the recycling plant?",
    answer:
      "Depending on the selected model, production capacities range from 80 Kg/hr to 220 Kg/hr, ensuring efficient processing of recycled plastic materials.",
  },
  {
    question: "Why is venting technology important in plastic recycling?",
    answer:
      "High-efficiency venting removes moisture, volatile gases, contaminants, and trapped air from recycled materials, resulting in better melt quality and stronger finished pellets.",
  },
  {
    question: "What are the advantages of two-stage recycling systems?",
    answer:
      "Two-stage recycling systems provide improved degassing, better material mixing, higher pellet quality, lower impurity levels, and enhanced processing stability compared to single-stage systems.",
  },
  {
    question: "Can the machine process printed and contaminated plastic waste?",
    answer:
      "Yes. The plant is designed to process post-industrial and post-consumer plastic waste with effective filtration and degassing systems for improved recycling results.",
  },
  {
    question: "What is a Plastic Palletizing Plant?",
    answer:
      "A Plastic Palletizing Plant converts molten recycled plastic into uniform pellets or granules that can be reused as raw material in plastic manufacturing processes.",
  },
  {
    question:
      "How does the hydraulic screen changer improve recycling efficiency?",
    answer:
      "The hydraulic screen changer continuously removes impurities and contaminants from molten plastic without interrupting production, ensuring high-quality recycled pellets.",
  },
  {
    question: "Which industries use recycled plastic pellets?",
    answer:
      "Recycled plastic pellets are widely used in packaging, automotive components, household products, construction materials, plastic pipes, injection molding, and extrusion industries.",
  },
  {
    question: "Is the recycling plant suitable for continuous production?",
    answer:
      "Yes. HPMC Recycling Plants are designed for continuous operation with reliable performance, efficient material processing, and minimal downtime.",
  },
  {
    question: "How energy efficient is the Two Stage Recycling Plant?",
    answer:
      "The machine is engineered with optimized screw designs, efficient heating systems, and advanced processing technology to maximize output while minimizing energy consumption.",
  },
  {
    question: "What are the benefits of recycling plastic materials?",
    answer:
      "Plastic recycling reduces waste, lowers raw material costs, conserves natural resources, decreases environmental impact, and supports sustainable manufacturing practices.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "HPMC Recycling Plants offer excellent plasticization, superior venting performance, high-quality pellet production, reliable operation, energy-efficient processing, and long-term durability.",
  },
];
